@ST_7866 @tagtagtag @this_is_story_tag
...
@SC_52074 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_52075 @third_scenario_tag
...
@SC_52076 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_52077 @fifth_scenario_tag
